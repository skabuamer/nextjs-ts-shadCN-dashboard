...
export default function cardList() {
	return (
		<div>
			<h1 className="mb-10 text-lg font-medium">Latest Transactions</h1>
			<div className="flex flex-col gap-4">
				{latestTransactions.map((item) => (
					<Card key={item.id} className="flex justify-between gap-4 p-4 flex-row items-center rounded-lg">
