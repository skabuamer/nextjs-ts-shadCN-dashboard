		...
		<div>
			<Breadcrumb>
				<BreadcrumbList>
					...
					<BreadcrumbSeparator />
					<BreadcrumbItem>
						<BreadcrumbPage>John Died</BreadcrumbPage>
					</BreadcrumbItem>
				</BreadcrumbList>
			</Breadcrumb>
			...
			<div className="mt-4 flex flex-col xl:flex-row gap-8">
				...
				<div className="w-full xl:w-1/3 space-y-6">
					...
					{/* CARD LIST CONTAINER */}
					<div className="bg-primary-foreground p-4 rounded-lg hidden">{/* <CardList title="Recent Transactions" /> */}</div>
				</div>
				{/* RIGHT */}
						...
						<div className="bg-primary-foreground p-4 rounded-lg space-y-2">
							<div className="flex items-center gap-2">
								<Avatar className="size-12">
									<AvatarImage src="https://avatars.githubusercontent.com/u/97892768?v=4" />
									<AvatarFallback>JD</AvatarFallback>
								</Avatar>
								<h1 className="text-xl font-semibold">John Doe</h1>
							</div>
							<p className="text-sm text-muted-foreground">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Vel voluptas distinctio ab ipsa commodi fugiat labore quos veritatis cum corrupti sed repudiandae ipsum, harum recusandae ratione ipsam in, quis quia.</p>
						</div>
					</div>
					{/* CHART CONTAINER */}
					<div className="bg-primary-foreground p-4 rounded-lg">
